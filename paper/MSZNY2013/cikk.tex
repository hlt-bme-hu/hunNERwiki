...
átirányító és egyértelműsítő lapok címeit gyűjtjük. Ha ezután egy olyan mondattal  % TODO: + idegen nyelvi megfelelők!
...
A következő tipikus hibák rajzolódtak ki.

Típushiba kevés, ennél gyakoribb az álnegatív/álpozitív, még gyakoribb pedig a határok nem pontos felismerése. %TODO: részletesen, referálva a táblázatokra.

Bizonyos esetekben a név környezetében lévő értelmező szerepű nyelvi egység is a
névvel együtt annotálva lett. Ennek az az oka, hogy maga a Wikipédia címszó is
tartalmazza ezt a szót, mely leszűkíti a név referenciáját,
pl.~\textit{ókori Róma}, \textit{magyar Wikipédia}. Emberekre utaló linkek esetében
ezek nagyrészt rangjelzők, pl.~\textit{Szent István király}, \textit{Anna brit királynő}.
Ez utóbbiakat egy rangjelző szavakat tartalmazó tiltólistával a későbbiekben ki
lehet szűrni. 

A hibák egy részét az alkalmazott nyelvfeldolgozó eszközök tévesztései okozzák.
...
alkalmazott eszközök teljesítményének javítása, vagy más eszközök alkalmazása.
...
Wikipédia korpusz annotálási pontossága közelíti a gold standard korpuszokét. %na ide jöhetnek majd pontos adatok 
...
\end{tabular}
\end{center}
\caption{Az inter-annotátor egyezés értékelése.}  % TODO: magyarul
\label{tab:f_score}
\end{table}
...
Álpozitív& 83 & 1 & & 2 \\
Álnegatív &  & 26 & 1 & 1 \\
Részlegesen felismert nevek & & & & \\
\bottomrule
\end{tabular}
\end{center}
\caption{A hibásan tulajdonnévként felismert szavak (álpozitív), illetve a
         fel nem ismert tulajdonnevek száma}  % TODO: these should be the row headers in the table
\label{tab:fp_fn}
\end{table}
