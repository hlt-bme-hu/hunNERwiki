...
Our solution is similar to Nothman's \shortcite{Nothman:09}. Instead of a trie, however, we use a set, albeit with more alias types. We expect more precise tagging from our slightly more rigorous solution.
