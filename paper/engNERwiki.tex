...
A NER training corpus consists of sentences that contain "gold" quality information about the named entities (or lack thereof) occuring in them: XXX In order to achieve 

The text in Wikipedia is 
Unknown entities might or might not be 

whose validity is 

Some  Resolving these links results in a STAT increase in recall.
